...
#     <summary><h4><strong>Hint 2</strong></h4></summary>
# 
# Keep in mind that the second index value passed into bracket notation is exclusive.
# 
# </details>
...
#     <summary><h4><strong>Hint 3</strong></h4></summary>
# 
# Given that the second index value passed into bracket notation is exclusive and indexing in Python starts at `0`, the first index value should be `0` and the second index value should be `3`, in order to extract the first through the third characters in `device_id`.
# 
# </details>
